...
public class Teesorte {
	...
	public Teesorte(int identnummer, String bezeichnung, String kategorie, String mitKoffein,
	...
	public String gibTeesorteZurueck(char trenner) {
		return this.getIdentnummer() + trenner + this.getBezeichnung() + trenner + this.getKategorie() + trenner
